...
interface NexusModsButtonProps {
  onClick?: () => void;
  size?: "small" | "medium" | "large";
  ariaLabel?: string;
}

const NexusModsButton: React.FC<NexusModsButtonProps> = ({
  onClick,
  size = "medium",
  ariaLabel = "Nexus Mods",
}) => {
  // Size configurations
  const sizeStyles = {
    small: "w-8 h-8",
  ...
  return (
    <button
      onClick={onClick}
      className={`${sizeStyles[size]} bg-gray-900 hover:bg-gray-800 rounded-full flex items-center justify-center transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-orange-500 dark:bg-gray-800 dark:hover:bg-gray-700`}
      ...
      >
        <g>
          ...
          <g>
            ...
            <g>
              <g>
                <circle fill="#DA7A18" cx="81.4" cy="80.8" r="60.5"></circle>
              </g>
            </g>
            <g>
              <path
...
export default NexusModsButton;
